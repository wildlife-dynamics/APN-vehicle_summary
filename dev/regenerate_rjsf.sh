...
GENERATED_DIR="ecoscope-workflows-vehicle-summary-workflow"
REGISTRY_BIN="${GENERATED_DIR}/.pixi/envs/default/bin/wt-registry"
REGISTRY_JSON="/tmp/wt_registry_apn_vehicle_summary.json"
...
out = Path('$GENERATED_DIR') / 'ecoscope_workflows_vehicle_summary_workflow' / 'rjsf.json'
